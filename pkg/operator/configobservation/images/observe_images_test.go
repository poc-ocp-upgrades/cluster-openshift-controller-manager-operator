...
func TestObserveRegistryConfig(t *testing.T) {
	...
	imageConfig := &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Status: configv1.ImageStatus{InternalRegistryHostname: expectedInternalRegistryHostname}}
